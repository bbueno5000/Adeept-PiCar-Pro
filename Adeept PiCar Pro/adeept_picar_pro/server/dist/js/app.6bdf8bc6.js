    ...
    function (t) {
        function e(e) {
            for (var o, r, i = e[0], c = e[1], l = e[2], d = 0, h = []; d < i.length; d++)
                r = i[d], Object.prototype.hasOwnProperty.call(s, r) && s[r] && h.push(s[r][0]), s[r] = 0;
            for (o in c)
                Object.prototype.hasOwnProperty.call(c, o) && (t[o] = c[o]); u && u(e);
            while (h.length)
                h.shift()();
        ...
        "56d7": function (t, e, n) {
            ...
            var w = function () {
                ...
                x = function () {
                    ...
                    return n(
                        ...
                        [
                            n("p", { staticClass: "mod-title" }, [t._v(t._s(t.modName))]),
                            n("div", { staticClass: "mod-wrapper" }, [t._t("default")], 2)
                        ]
                    )
                },
                _ = [],
                ...
                methods: Object(E["a"])(
                    {
                        setVedioTimmer: function () {
                            var t = this;
                            this.timmer && (clearInterval(this.timmer), this.rand = Math.random()), this.timmer = setInterval(
                                (
                                    function () {
                            ...
                            (
                                function (e, o) {
                                    return n(
                                        ...
                                        [
                                            n("b", { staticClass: "chip-title" }, [t._v(t._s(e[0] + " " + e[1]))]),
                                            t._v(" " + t._s(e[2] + e[3]) + " ")
                                        ]
                                    )
                                }
                    ...
                    watch: {
                        wsResponse: function () {
                            if ("get_info" === this.wsResponse.title) {
                                var t = this.wsResponse.data; console.log(t);
            ...
            var z = function () {
                ...
                Y = {
                    ...
                    methods: Object(E["a"])(
                        ...
                        {},
                        Object(I["c"])(["setKeyEvent"])),
                    mounted: function () {
                        var t = this;
                        "" === this.attr && (this.attr = { isIcon: !1, content: "" }), this.setKeyEvent(
                            [this.attr.sendKey, function () { t.changeWsContent(t.attr.sendContent) }, "down"]),
                            this.setKeyEvent([this.attr.sendKey, function () { t.changeWsContent(t.attr.upSendContent) }, "up"])
                    }
                },
                Z = Y,
                tt = (n("3c32"), n("8336")),
            ...
            var st = {
                ...
                wt = {
                    ...
                    watch: {
                        speed: function () {
                            var t = this;
                            this.timmer && clearTimeout(this.timmer), this.timmer = setTimeout((function () { t.changeWsContent("wsB " + String(t.speed)) }), 300)
                        }
                    }
                },
                kt = wt, yt = n("ba0d"), St = Object(h["a"])(kt, bt, gt, !1, null, "65369f3e", null), xt = St.exports;
            m()(St, { VSlider: yt["a"] });
            var _t = function () {
                var t = this, e = t.$createElement, n = t._self._c || e;
                return n(
                                    ...
                                    function (e) {
                                        return n(
                                            "v-slider",
                                            {
                                                ...
                                                model: {
                                                    value: t.values[e][0],
                                                    callback: function (n) { t.$set(t.values[e], 0, n) },
                ...
                methods: Object(E["a"])(
                    {
                        handleColorChange: function () {
                            "#000000" === this.CVFLColor ? (
                                this.changeCVFLColor("#FFFFFF"), this.changeWsContent("CVFLColorSet 255")) : (
                                    this.changeCVFLColor("#000000"), this.changeWsContent("CVFLColorSet 0")
                            )
                        },
                        handleValueChange: function (t) {
                            "L1" === t ? this.changeWsContent(
                                "CVFLL1 " + this.values.L1[0]) : "L2" === t ? this.changeWsContent(
                                    "CVFLL2 " + this.values.L2[0]) : "SP" === t ? this.changeWsContent(
                                        "CVFLSP " + this.values.SP[0]) : "EXP" === t && this.changeWsContent(
                                            "CVFLEXP " + this.values.EXP[0]
                            )
                        }
                    },
                    Object(I["b"])(["changeWsContent"]),
                    {},
                    Object(I["c"])(["changeCVFLColor"])
                    )
                }
                ),
                Ot = Ft,
                Vt = (n("82da"), Object(h["a"])(Ot, _t, Mt, !1, null, "38858175", null)), Wt = Vt.exports;
            ...
            var At = function () {
                ...
                return n(
                    ...
                    [
                        n(
                            "ControlButton",
                            {
                                staticClass: "button", attrs: { attr: t.buttonAttr }
                            }
                        ),
                        n(
                            "v-menu",
                            ...
                            [
                                n(
                                    ...
                                    [
                                        n("ColorPickerChild", { on: { colorChange: t.handleColorChange } })
                                    ],
                                    1
                                )
                            ]
                        ...
                        n(
                            "v-color-picker",
                            {
                                ...
                                model: {
                                    ...
                                    callback: function (e) { t.selectedColor = e },
                ...
                Lt = {
                    ...
                    watch: {
                        selectedColor: {
                            handler: function (t, e) {
                                var n = this;
                                this.timmer && clearTimeout(this.timmer), this.timmer = setTimeout(
                                    (
                                        function () {
                    ...
                    mounted: function () { this.selectedColor = this.defaultColor }
                },
                Pt = Lt,
                Rt = (n("e5bf"), n("03a4")),
            ...
            var Tt = {
                ...
                methods: Object(E["a"])({ handleColorChange: function (t) { this.changeFCColor(t) } },
            ...
            }, Bt = Tt, Ht = (n("1b85"), n("e449")), Dt = Object(h["a"])(Bt, At, jt, !1, null, "5a57ef1d", null), Kt = Dt.exports;
            ...
            }, zt = [], Gt = n("53ca"), Jt = n("313e"), qt = n.n(Jt), Xt = function () {
                var t = this, e = t.$createElement, n = t._self._c || e;
                return n(
                    "div",
                    {
                    ...
                    name: "CommonMask",
                    props: { status: Number, content: String },
                    data: function () {
                        return {
                            ripple: !0,
                            maskContent: "",
                    ...
                    handleMaskClick: function () { this.scaning },
                    methods: {
                        isLoading: function () {
                            var t = this;
                            this.loadingInterval ? (
                                ...
                                (
                                    function () {
                                        t.intervalCounter++, t.intervalCounter > 3 ? (
                                            t.intervalCounter = 0, t.contentSuffix = "") : t.contentSuffix = t.contentSuffix + "."
                                    }
                                ),
                                666
                            )
                    ...
                    watch: {
                        status: function () {
                            1 === this.status ? (
                                this.ripple = !1, this.isLoading(), this.$set(this.maskClass, 1, ""),
                                this.maskStyle["background-color"] = "rgba(22,22,22,0.3)",
                                this.maskFontStyle["margin-top"] = "0"
                            ) : 2 === this.status && (
                                    this.isLoading(), this.maskStyle["background-color"] = "rgba(22,22,22,0.0)",
                                    this.maskStyle.transition = "background-color 0.5s ease-in",
                                    this.maskFontStyle["margin-top"] = "-400px"
                            )
                        }
                    },
                    mounted: function () { this.maskContent = this.content }
                }, Zt = Yt, te = (n("3039"), n("269a")), ee = n.n(te), ne = n("5607"), oe = Object(h["a"])(Zt, Xt, Qt, !1, null, "414d16b2", null), se = oe.exports;
            ee()(oe, { Ripple: ne["a"] });
            var ae = {
                name: "Radar",
                ...
                distory: function () { window.removeEventListener("resize", this.handleWindowResize) }
            }, re = ae, ie = (n("44e6"), Object(h["a"])(re, Ut, zt, !1, null, "8995e32c", null)), ce = ie.exports, le = function () {
                var t = this, e = t.$createElement, n = t._self._c || e;
                return n(
                    "v-expansion-panels",
                    {
                        ...
                        model: {
                            value: t.witchOpen,
                            callback: function (e) { t.witchOpen = e },
                        ...
                        [
                            n(
                                "v-text-field",
                                {
                                    ...
                                    model: {
                                        value: t.PWMNum,
                                        callback: function (e) { t.PWMNum = e },
                                        expression: "PWMNum"
                                    }
                                }
                            ),
            ...
            var ze = {
            ...
            }, Ge = ze, Je = Object(h["a"])(Ge, w, k, !1, null, null, null), qe = Je.exports, Xe = function () {
                var t = this, e = t.$createElement, n = t._self._c || e;
                return n(
                    "div",
                    [
                        n(
                            "v-snackbar",
                            {
                                ...
                                model: {
                                    ...
                                    callback: function (e) { t.reconnectTip = e },
                            ...
                            [
                                ...
                                n("AniLoading"),
                                n("v-overlay", { attrs: { absolute: "", opacity: 0 } })
                            ],
                            1
                        )
                    ],
                ...
                tn = {
                    ...
                    data: function () {
                        return {
                            lightStyle: { height: "52px", "margin-left": "-10%", "transition-duration": "1.3s" },
                            timer: null
                        }
                    },
                    mounted: function () {
                        var t = this;
                        this.lightStyle.height = this.$el.parentNode.offsetHeight + 50 + "px", this.$el.parentNode.style.position || (this.$el.parentNode.style.position = "relative"), this.timer = setInterval(
                            (
                                function () {
                                    "-10%" === t.lightStyle["margin-left"] ? (
                                        t.lightStyle["margin-left"] = "105%",
                                        t.lightStyle["transition-duration"] = "1.3s"
                                    ) : (t.lightStyle["margin-left"] = "-10%", t.lightStyle["transition-duration"] = "0s")
                                }
                            ),
                            1300
                        )
                ...
                sn = {
                    ...
                    data: function () { return { websock: null, reconnectTip: !1 } },
                    components: { AniLoading: on },
                    computed: Object(E["a"])({}, Object(I["d"])(["wsContent", "setVedioTimmer"])),
                    created: function () { this.initWebSocket() },
                    destroyed: function () { this.websock.close() },
                    methods: Object(E["a"])(
                        {
                            ...
                            websocketonopen: function () { this.websock.send("admin:123456") },
                            ...
                            websocketclose: function (t) { this.reconnectTip = !0, this.initWebSocket() }
                        },
                        ...
                        wsContent: function () {
                            if (this.wsContent) {
                                try {
                                    ...
                                    console.log("Connection closed or connecting，unable to send data"), this.changeWsContent("")
                                }
                            }
                        }
                    }
            ...
            var gn = vn, wn = (n("7faf"), n("7496")), kn = n("a75b"), yn = Object(h["a"])(gn, r, i, !1, null, null, null), Sn = yn.exports;
            ...
            Object(xn["a"])("".concat("/", "service-worker.js"), {
                ...
                registered: function () { console.log("Service worker has been registered.") },
                cached: function () { console.log("Content has been cached for offline use.") },
                updatefound: function () { console.log("New content is downloading.") },
                updated: function () { console.log("New content is available; please refresh.") },
                offline: function () { console.log("No internet connection found. App is running in offline mode.") },
                error: function (t) { console.error("Error during service worker registration:", t) }
            }
            );
            var _n = n("8c4f");
            o["a"].use(_n["a"]);
            ...
            var Vn = new I["a"].Store(
                {
                    ...
                    actions: {
                        changeWsContent: function (t, e) { t.commit("changeWsContent", e) },
                        changeWsResponse: function (t, e) { e && t.commit("changeWsResponse", e) }
                    },
                    mutations: {
                        changeSetVedioTimmer: function (t, e) { t.setVedioTimmer = e },
                        changeCVFLColor: function (t, e) { t.CVFLColor = e },
                        changeFCColor: function (t, e) { console.log(e), t.FCColor = e },
                        changeWsContent: function (t, e) { t.wsContent = e },
                        changeWsResponse: function (t, e) { t.wsResponse = e },
                        setKeyEvent: function (t, e) { e && e[0] && e[1] && e[2] && (t.keyEvents[e[2]][e[0]] = e[1]) }
                    },
                    modules: {}
                }
            );
            ...
            o["a"].config.productionTip = !1, o["a"].prototype.RGBToHSV255 = function (t) {
                ...
                new o["a"]({ router: On, store: Vn, vuetify: a, render: function (t) { return t(Sn) } }).$mount("#app")
        },
